<div class="sidebar bg-light p-3">
    ...
    <ul class="nav flex-column">
        <li class="nav-item"><a href="<?= BASE_URL ?>/views/admin/dashboard/" class="nav-link">Dashboard</a></li>
        <li class="nav-item"><a href="<?= BASE_URL ?>/views/admin/manage_users.php" class="nav-link">Manage Users</a></li>
